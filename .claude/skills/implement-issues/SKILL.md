...
The agent handles everything: reading the issue, designing experiments, building the harness, red/green phases, committing, and PR submission. DO NOT TELL THE AGENT HOW/WHERE TO WRITE ITS TESTS.
